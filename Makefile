...
DEBUG=true
OPTIMIZATION=-g3 -O0
DISABLED_WARNINGS=-Wno-unused-but-set-variable -Wno-unused-variable -Wno-unused-function -Wno-unused-command-line-argument -Wno-unused-parameter -Wno-unused-value
